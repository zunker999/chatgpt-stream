...
public class OpenAiWebClient {
    ...
    public void initDev() {
        ...
        HttpClient httpClient = HttpClient.create()
                ...
                .tcpConfiguration(tcpClient -> tcpClient.proxy(proxy -> proxy.type(ProxyProvider.Proxy.HTTP).host("127.0.0.1").port(7890)));
...
/**=========================================================================================================**/
     ...
     * @param filePath           语音文件 最大支持25MB mp3, mp4, mpeg, mpga, m4a, wav, webm
     * @return 语音文本
     */
    public Flux<String> audioToTextTranscriptions(String filePath, Transcriptions transcriptions) {
        log.info("file start translate");
        FileSystemResource resource = new FileSystemResource(filePath);
        MultiValueMap<String, Object> bodyMap = new LinkedMultiValueMap<>();
        bodyMap.add("model", transcriptions.getModel());
        bodyMap.add("file", resource);
        Flux<String> stringFlux = webClient
                .post()
                .uri(ApiConstant.TRANSCRIPTIONS_API)
                .header(HttpHeaders.AUTHORIZATION, "Bearer " + authorization)
...
//        stringFlux.subscribe(res -> System.out.println(res));
        return stringFlux;
    }
